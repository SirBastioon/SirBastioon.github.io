...
function SectionHero() {
  return (
    <section 
      id="hero" 
      className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-white" // Hintergrundfarbe weiß
    >
      {/* Hintergrundebenen (Beispiel Formen, Verläufe) */}
      <div className="absolute inset-0 flex justify-center items-center">
        {/* Abstrakte Formen mit Verlaufs-Hintergründen oder importierten Bildern hinzufügen */}
